...
"""Check that it's not possible to start a second syscoind instance using the same datadir or wallet."""
import os

from test_framework.test_framework import SyscoinTestFramework
from test_framework.test_node import ErrorMatch

class FilelockTest(SyscoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            self.log.info("Check that we can't start a second syscoind instance using the same wallet")
