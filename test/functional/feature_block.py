...
class FullBlockTest(SyscoinTestFramework):
    ...
    def run_test(self):
        ...
        # Upstream Syscoin tests BIP30 here.  We cannot do that, as BIP34 is
        ...
        # syscoind doesn't disconnect us for sending a bloated block, but if we subsequently
