...
The first step is running Syscoin Core behind a Tor proxy. This will already anonymize all
...
your syscoind's P2P listen port (8333 by default).
	...
	-externalip=X   You can tell syscoin about its publicly reachable address using
	                ...
	                /var/lib/tor/syscoin-service/hostname. For connections
...
in `torrc` config file. For cookie authentication the user running syscoind must have read
...
- Do not add anything but Syscoin Core ports to the hidden service created in section 2.
