Syscoin Core version 0.16.3 is now available from:

  <https://syscoincore.org/bin/syscoin-core-0.16.3/>
...
been discovered in Syscoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` syscoinconsensus: invalid flags error should be set to `syscoinconsensus_err` (afk11)
