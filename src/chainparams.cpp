...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.syscoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.syscoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.syscoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.syscoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.sys.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.syscoin.sprovoost.nl"); // Sjors Provoost
